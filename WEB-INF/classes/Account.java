           ...
           response.setContentType("text/html");
			...
			if(size>0)
				{					
					...
					pw.print("<th style='text-align:center;'>Product Price</th></tr>");
					for(Map.Entry<Integer, ArrayList<OrderPayment>> entry : orderPayments.entrySet())
					{
						...
						switch(user.getUsertype()){
							case "customer":
								if(oi.getUserName().equals(user.getName())) 
								{
									...
									pw.print("<td style='font-size:14px; text-align:center;'>"+oi.getOrderId()+".</td>");
									pw.print("<td style='font-size:14px; text-align:center;'>"+oi.getUserName()+"</td>");
									pw.print("<td style='font-size:14px; text-align:center;'>"+oi.getOrderName()+"</td>");
									pw.print("<td style='font-size:14px; text-align:center;'>"+oi.getOrderPrice()+"</td>");
