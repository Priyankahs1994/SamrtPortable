...
public class PetTrackerList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		  if(ProductName.equals("Whistle GO"))
		  {
			for(Map.Entry<String,PetTracker> entry : SaxParserDataStore.pettrackers.entrySet())
				{
				if(entry.getValue().getRetailer().equals("Whistle GO"))
				 {
		  ...
		  else if(ProductName.equals("FitBark GPS"))
		  {
			for(Map.Entry<String,PetTracker> entry : SaxParserDataStore.pettrackers.entrySet())
				{
				if(entry.getValue().getRetailer().equals("FitBark GPS"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}	
