...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta'><a style='font-size: 36px;color:#61080c !important;'>Register Here<br><br></a></h2>"
				+ "<div class='entry'>"
				+ "<div class='post1'>");
		if (error)
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "<h3 style='color:#61080c !important;'>Username</h3></td><td><input type='text' name='username' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3 style='color:#61080c !important;'>Password</h3></td><td><input type='password' name='password' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3 style='color:#61080c !important;'>Re-Password</h3></td><td><input type='password' name='repassword' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3 style='color:#61080c !important;'>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='retailer'>Store Manager</option><option value='manager'>Salesman</option></select>"
				+ "</td></tr></table>"
				+ "<br>"
				+ "<br>"
